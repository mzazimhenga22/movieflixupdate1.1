...
import 'package:movie_app/components/movie_card.dart'; // kept for mobile grid compatibility
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  final List<FocusNode> _keyboardKeyNodes = [];
  ...
  bool _isLargeScreen(BuildContext context) {
    ...
    // Consider it TV mode when width >= 900 or diagonal is large
                ...
                : FutureBuilder<List<dynamic>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (isTv) {
                        return Column(
                          children: [
                            Expanded(child: SingleChildScrollView(child: _buildTvResults(results, accentColor))),
                            // Show the on-screen keyboard only when search field is focused or explicitly requested.
                            // We'll show it when search field has focus (TV remote should focus it to type)
                            Focus(
                              focusNode: _searchFieldFocusNode,
                              child: Builder(builder: (ctx) {
                                final showKeyboard = Focus.of(ctx).hasFocus;
                                return AnimatedCrossFade(
                                  ...
                                  crossFadeState: showKeyboard ? CrossFadeState.showSecond : CrossFadeState.showFirst,
  ...
  void dispose() {
    ...
    for (final n in _keyboardKeyNodes) {
      n.dispose();
    }
          ...
          child: FocusableActionDetector(
            ...
            child: Builder(builder: (ctx) {
              ...
              return AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: focused ? Colors.white10 : Color.fromRGBO(255, 255, 255, 0.04),
