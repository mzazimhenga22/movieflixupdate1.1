  ...
  Future<void> _refreshProfiles() async {
    ...
    try {
      ...
      if (snapshot.docs.isNotEmpty) {
        debugPrint('🔄 Found ${snapshot.docs.length} profiles in Firestore cache');
        ...
        debugPrint('ℹ️ No profiles in Firestore cache, trying server');
        ...
        if (serverSnapshot.docs.isNotEmpty) {
          debugPrint('🔄 Found ${serverSnapshot.docs.length} profiles from server');
      ...
      child: AnimatedBorderBox(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            image: background.startsWith("assets/")
                ? DecorationImage(
